...
/**
 * ApproximationResult Class Doc Comment
 *
 * @category    Class */
 // @description ApproximationResult результат рассчета аппроксимации по цене и пробегу
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ApproximationResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ApproximationResult';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['mean_price'] = isset($data['mean_price']) ? $data['mean_price'] : null;
        $this->container['mean_run'] = isset($data['mean_run']) ? $data['mean_run'] : null;
    }
    ...
    {
        return $this->container['mean_price'];
    }

    /**
     * Sets mean_price
     * @param int $mean_price
     * @return $this
     */
    public function setMeanPrice($mean_price)
    {
        $this->container['mean_price'] = $mean_price;
     ...
     * @return int
     */
    public function getMeanRun()
    {
        return $this->container['mean_run'];
    }
     ...
     * @return $this
     */
    public function setMeanRun($mean_run)
    {
        $this->container['mean_run'] = $mean_run;
