...
/**
 * InSaleResult Class Doc Comment
 *
 * @category    Class */
 // @description InSaleResult результат собранный по данным с рынка
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InSaleResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'InSaleResult';
    ...
    protected static $swaggerTypes = array(
        'autos' => '\Swagger\Client\Model\InSaleAuto[]',
        'complete' => 'bool'
    );
    ...
    {
        $this->container['autos'] = isset($data['autos']) ? $data['autos'] : null;
    ...
    /**
     * Gets autos
     * @return \Swagger\Client\Model\InSaleAuto[]
     */
    public function getAutos()
    {
        return $this->container['autos'];
    }

    /**
     * Sets autos
     * @param \Swagger\Client\Model\InSaleAuto[] $autos Список автомобилей
     * @return $this
     */
    public function setAutos($autos)
    {
        $this->container['autos'] = $autos;
    ...
    /**
     * Sets complete
     * @param bool $complete Маркер завершенности получения данных
     * @return $this
     */
